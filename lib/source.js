...
var Source = function (_Player) {
  ...
  function Source(rootNodeOrSelector) {
    ...
    var _this = _possibleConstructorReturn(this, (Source.__proto__ || Object.getPrototypeOf(Source)).call(this, rootNodeOrSelector, collectionSelector, itemSelector));
  ...
  _createClass(Source, [{
    ...
    value: function onSelectionChange() {
      ...
      commonAncestor.getElementsByTagName('*').forEach(function (candidate) {
