...
var Player = function () {
  ...
  _createClass(Player, [{
    ...
    key: 'setHeadOLD',
    value: function setHeadOLD(time, src) {
      this.currentSrc = src;
      var found = false;
      ...
      for (var j = 0; j < items.length; j++) {
        ...
        var _first$getAttribute$s3 = first.getAttribute('data-t').split(','),
            _first$getAttribute$s4 = _slicedToArray(_first$getAttribute$s3, 1),
            t0 = _first$getAttribute$s4[0];
        ...
        var _last$getAttribute$sp3 = last.getAttribute('data-t').split(','),
            _last$getAttribute$sp4 = _slicedToArray(_last$getAttribute$sp3, 2),
            ti = _last$getAttribute$sp4[0],
            di = _last$getAttribute$sp4[1];
        ...
        for (var i = 0; i < candidates.length; i++) {
          ...
          var _tc$split3 = tc.split(','),
              _tc$split4 = _slicedToArray(_tc$split3, 2),
              t = _tc$split4[0],
              d = _tc$split4[1];
    ...
    value: function getMedia(src, type) {
      ...
      if (media && !media.classList.contains('hyperaudio-enabled')) {
        ...
        media.addEventListener('play', function (event) {
          ...
          var t = _this2.root.querySelector('.hyperaudio-transport');
          t.classList.add('hyperaudio-playing');
          if (!_this2.root.querySelector('.hyperaudio-current') && _this2.root.querySelector('.hyperaudio-transcript')) {
            _this2.root.querySelector('.hyperaudio-transcript').classList.add('hyperaudio-current');
          }
        });
