    ...
    value: function getMedia(src, type) {
      ...
      if (media && !media.classList.contains('hyperaudio-enabled')) {
        ...
        media.addEventListener('play', function (event) {
          ...
          var t = _this3.root.querySelector('.hyperaudio-transport');
          t.classList.add('hyperaudio-playing');
          if (!_this3.root.querySelector('.hyperaudio-current') && _this3.root.querySelector('.hyperaudio-transcript')) {
            _this3.root.querySelector('.hyperaudio-transcript').classList.add('hyperaudio-current');
          }
        });
